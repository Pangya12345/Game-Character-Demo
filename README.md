...
- **พิมพ์หรือพูดก็ได้**: กดปุ่มไมค์ 🎤 แล้วพูด ระบบจะแปลงเสียงเป็นข้อความตามภาษาที่เลือก (ไทย th-TH / อังกฤษ en-US) แล้วส่งให้แม่ค้าเองเมื่อพูดจบ ใช้ระบบฟังเสียงที่มากับเบราว์เซอร์ (Chrome, Edge, Safari) จึงไม่ต้องใช้ API key เพิ่ม
