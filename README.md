...
- **พิมพ์หรือพูดก็ได้**: กดปุ่มไมค์ 🎤 แล้วพูด ระบบจะแปลงเสียงเป็นข้อความตามภาษาที่เลือก (ไทย th-TH / อังกฤษ en-US) ขึ้นในช่องแชท แล้วกด Enter หรือ SEND เพื่อส่ง (ไม่ส่งเอง จะได้แก้คำที่ฟังผิดก่อนได้) ใช้ระบบฟังเสียงที่มากับเบราว์เซอร์ (Chrome, Edge, Safari) จึงไม่ต้องใช้ API key เพิ่ม
...
- **ความอดทนของแม่ค้า (0–100)**: แถบด้านบนลดลงเรื่อย ๆ ตอนเงียบ (ระหว่างกำลังพิมพ์จะลดช้าลงประมาณ 3 เท่า แต่ไม่หยุด) และลดเมื่อต่อต่ำเกินเหตุ ถามซ้ำ พูดไม่ดี หรือพูดผิดภาษา แต่เพิ่มขึ้นเมื่อพูดสุภาพ ให้เหตุผลดี หรือชวนคุยถูกใจ (AI ประเมินทุกข้อความ ส่วน server บังคับกติกาหลัก) ทุก 25 วินาทีที่เงียบ แม่ค้าจะบ่นและขึ้นราคา 5 บาท ความอดทนหมด = โดนไล่ ดีลล่ม
