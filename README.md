...
- **ความอดทนของแม่ค้า (0–100)**: แถบด้านบนลดลงเรื่อย ๆ ตอนเงียบหรือพิมพ์ค้างไว้ไม่ส่ง และลดเมื่อต่อต่ำเกินเหตุ ถามซ้ำ พูดไม่ดี หรือพูดผิดภาษา แต่เพิ่มขึ้นเมื่อพูดสุภาพ ให้เหตุผลดี หรือชวนคุยถูกใจ (AI ประเมินทุกข้อความ ส่วน server บังคับกติกาหลัก) ทุก 25 วินาทีที่เงียบ แม่ค้าจะบ่นและขึ้นราคา 5 บาท ความอดทนหมด = โดนไล่ ดีลล่ม
