...
- **Idle timer**: ถ้าเงียบครบเวลา แม่ค้าจะขึ้นราคาครั้งละ 5 บาท (ครั้งที่ 1–3) และหงุดหงิดขึ้นเรื่อย ๆ ครั้งที่ 3 จะเป็นคำเตือนสุดท้าย ถ้ายังเงียบต่อเป็นครั้งที่ 4 จะ **โดนไล่ ดีลล่ม** ทันทีที่ส่งข้อความ ตัวนับจะเริ่มใหม่ (ระหว่างที่กำลังพิมพ์ ตัวจับเวลาจะเริ่มนับใหม่ด้วย)
